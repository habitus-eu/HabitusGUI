...
test_that("Correct tools are proposed by test_identify_tools", {
  available_tools = c("GGIR", "PALMSpy", "hbGPS", "hbGIS", "CountConverter")
  ...
  expect_equal(sce1$tools_needed, c("GGIR", "hbGIS", "hbGPS")) 
  expect_equal(sce1$iotools[[1]]@output, c("GGIR_out", "ACount"))
  expect_equal(sce1$iotools[[3]]@output, "hbGIS_out")
  ...
  expect_equal(sce3$tools_needed, c("hbGIS", "hbGPS"))
  expect_equal(sce3$iotools[[2]]@output, "hbGIS_out")
  ...
  expect_equal(sce4$tools_needed, c("GGIR", "hbGIS", "hbGPS"))
  expect_equal(sce4$iotools[[2]]@output, "hbGIS_out")
  ...
  expect_equal(sce5$tools_needed, c("GGIR", "hbGIS", "hbGPS"))
