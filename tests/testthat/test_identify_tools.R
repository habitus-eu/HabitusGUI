...
test_that("Correct tools are proposed by test_identify_tools", {
  ...
  expect_equal(sce1$tools_needed, c("GGIR", "PALMSpy", "palmsplusr")) 
  ...
  expect_equal(sce3$tools_needed, c("PALMSpy", "palmsplusr"))
  ...
  sce4 = identify_tools(datatypes = c("AccRaw", "GPS", "GIS"),
                        goals = c("PA", "Sleep", "QC", "Trips", "Environment"),
                        available_tools = c("GGIR", "PALMSpy", "palmsplusr", "BrondCounts"))
  expect_equal(length(sce4$tools_needed), 4) 
  expect_equal(sce4$tools_needed, c("GGIR", "PALMSpy", "palmsplusr", "BrondCounts"))
  expect_equal(sce4$iotools[[2]]@output, "PALMSpy_out")
  expect_equal(sce4$iotools[[2]]@usecases, c("Trips", "QC", "Environment"))
  expect_equal(sce4$iotools[[4]]@output, "BrondCounts_out")
  ...
  expect_equal(sce5$tools_needed, c("GGIR", "PALMSpy", "palmsplusr"))
