...
test_that("Correct tools are proposed by test_identify_tools", {
  ...
  expect_equal(sce1$tools_needed, c("GGIR", "PALMSpy", "PALMSplus")) 
  expect_equal(sce1$iotools[[1]]@output, c("GGIR_out", "ACount"))
  expect_equal(sce1$iotools[[3]]@output, "PALMSplus_out")
  ...
  expect_equal(sce4$tools_needed, c("GGIR", "PALMSpy", "PALMSplus", "BrondCounts"))
