...
test_that("Parameters can be loaded and updated from config files", {
  ...
  params_ggir = params_ggir$params
  ...
  params_palmspy = params_palmspy$params
  ...
  params_palmsplusr = params_palmsplusr$params
  ...
  params_palmspy2 = params_palmspy2$params
  ...
  params_ggir2 = params_ggir2$params
  ...
  params_palmsplusr2 = params_palmsplusr2$params
